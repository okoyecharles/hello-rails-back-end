...
#### Github
- Enter this url: [https://github.com/OkoyeCharles/hello-rails-back-end/](https://github.com/OkoyeCharles/hello-rails-back-end/) in your web browser.
...
```sh
  git clone github.com/OkoyeCharles/hello-rails-back-end/.git
